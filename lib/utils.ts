...
// Removed stale constant `formatDateToday` which was evaluated at module load time.
// Use `getFormattedTodayDate()` instead to ensure the date is computed at call time.
